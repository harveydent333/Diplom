...
begin
   ...
   Edit1.Text:=DBGrid1.DataSource.DataSet.FieldByName('НазваниеКонтроля').AsString;
...
begin
    ...
    if Edit1.Text<>'' then
      begin
        ...
        if ((DataModule1.ADOModuleLecture.IsEmpty) or (updateKodControl=DBGrid1.DataSource.DataSet.FieldByName('КодКонтроля').AsInteger)) then
          unique_user:=true
        else
