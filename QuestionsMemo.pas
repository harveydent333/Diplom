...
begin
    with Add_Questions.VariantsQuestionSingle1 do
      begin
         Memo1.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв1').AsString);
         Memo2.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв2').AsString);
         Memo3.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв3').AsString);
         Memo4.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв4').AsString);
         Memo5.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв5').AsString);
         Memo6.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв6').AsString);
         Memo7.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв7').AsString);
         Memo8.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв8').AsString);
         Memo9.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв9').AsString);
         Memo10.Lines.Add(Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв10').AsString);
      end;
end;
...
begin
  Otv1:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв1').AsString;
  Otv2:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв2').AsString;
  Otv3:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв3').AsString;
  Otv4:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв4').AsString;
  Otv5:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв5').AsString;
  Otv6:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв6').AsString;
  Otv7:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв7').AsString;
  Otv8:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв8').AsString;
  Otv9:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв9').AsString;
  Otv10:=Add_Questions.DBGrid1.DataSource.DataSet.FieldByName('Отв10').AsString;
