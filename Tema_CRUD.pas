...
{
  Обработка нажатия кнопки добавить тему
}
...
{
  Обработка нажатия кнопки редактировать тему
}
...
begin
    ...
    if KodUser = BD.Request.DataSet.FieldByName('КодУчителя').AsInteger then
        ...
        MessageBox(0,'У вас нет прав на редактирование данной темы!','', MB_OK+MB_ICONwarning);
end;

{
  Обработка нажатия кнопки удалить тему
}
