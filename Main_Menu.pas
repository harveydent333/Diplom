...
begin
    ...
    DBGrid1.DataSource.DataSet.First;
    MenuLectures.ComboBox1.Text:=DBGrid1.DataSource.DataSet.FieldByName('НазваниеРаздела').AsString;
end;
...
begin
    ...
    DBGrid1.DataSource.DataSet.First;
    MenuPractic.ComboBox1.Text:=DBGrid1.DataSource.DataSet.FieldByName('НазваниеРаздела').AsString;
end;
